<x-ap-layout>
    <x-breadcrumb title="Imam dan Pembicara Baru" page="Imam dan Pembicara Management" active="Imam dan Pembicara Baru"
    ...
    <div
        ...
        <form action="{{ route('kultum.store') }}" method="POST">
            @csrf
            ...
            <div class="mb-5">
                ...
                <div x-data="{
                    ...
                    <input type="search" id="search-imam" x-model="search"
