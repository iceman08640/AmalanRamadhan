            ...
            <tbody>
                @forelse ($list_kultum as $kultum)
                    <tr>
                        ...
                        <td class="text-align-center">{{ hariIndoSyariah($kultum->agenda->tgl) }}</td>
                        <td class="text-align-center">{{ tglIndo($kultum->agenda->tgl) }}</td>
                        <td>{{ $kultum->imam->nama ?? '-' }}</td>
                        <td>{{ $kultum->kultum->nama ?? '-' }}</td>
                        <td>{{ $kultum->kulsub->nama ?? '-' }}</td>
                    </tr>
                @empty
                    <tr>
