<x-ap-layout>
    <x-breadcrumb title="Catatan Baru" page="Catatan" active="Catatan Baru"
    ...
    <div
        ...
        <form action="{{ route('catatan-surat.store', $masjid->id) }}" method="POST">
            @csrf
            ...
            <div class="mb-7">
                ...
                <ul class="grid w-full md:grid-cols-2">
                    <li>
                        <input type="radio" id="takjil" name="tipe" value="takjil" class="peer hidden"
                            required />
                        <label for="takjil"
                    ...
                    <li>
                        <input type="radio" id="kultum" name="tipe" value="kultum" class="peer hidden" />
                        <label for="kultum"
            ...
            <div class="mb-4">
                <x-input-label class="mb-2" for="konten">Konten <span
                        class="text-sm text-red-600">*</span></x-input-label>
                <textarea name="konten" id="konten" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required></textarea>
